            ...
            parts: [
              {
                ...
                text: "Extract all food items on this image in JSON format; valid fields are item, amount_count, amount_unit, and category. amount_count shall contain the numeric value of the item in terms of amount_unit. Predict the expiry date of each item based on its information and put the information in the field suggested_expiry_time. Extract the data of the buy time of the product by choosing the date of the receipt and place them inside the bought_time field in each item. All dates shall be written in ISO 8601 format. Remove all non-food from the result. Translate all item field to English.",
              },
              {
                inline_data: {
