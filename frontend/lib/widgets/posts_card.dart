              ...
              children: <Widget>[
                ...
                Positioned(
                    ...
                    child: TextButton(
                      ...
                      onPressed:  () async {    
                          ...
                          await sharedItemService.setLikedBy(widget.postData.id!, userId);
                      },
                      child: Icon(
                ...
                Positioned(
                    ...
                    child: Container(
                      ...
                      child: Text('${widget.postData.distance.toStringAsFixed(2)} m',
                          style: TextStyle(
                              color: Colors.white,
...
class likedItem extends StatefulWidget {
  ...
  const likedItem({super.key, required this.postData, required this.remainDays});
