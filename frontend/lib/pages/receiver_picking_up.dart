  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: FutureBuilder(
          future: sharedItemService.getSharedItem(widget.pickupProcess.sharedItemId),
          builder: (BuildContext context, AsyncSnapshot<SharedItem?> snapshot) {
            if (snapshot.hasData) {
